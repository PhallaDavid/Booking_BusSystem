...
<div class="container mx-auto py-8">
    ...
    <form action="{{ route('roles.store') }}" method="POST" class="bg-white p-6 rounded shadow-md">
        ...
        <div class="flex justify-end">
            <button type="submit" class="bg-gradient-to-r from-indigo-500 to-emerald-500 text-white px-6 py-2 rounded-lg shadow-md font-semibold transition hover:from-indigo-600 hover:to-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-400">Create Role</button>
        </div>
    </form>
</div>
@endsection